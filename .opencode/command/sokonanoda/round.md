...
6. **收尾**：`/sokonanoda/gate` 全绿；更新 `docs/STATUS.md`（新轮置顶）与新要求（追加 `docs/REQUIREMENTS.md` §9 并注明日期）；commit + push 并监控 CI 到终态（`skills/sokonanoda-ci`），失败必录 `docs/CI-FAILURES.md`。
