...
fn course_subcommand_aggregates_the_manifest() {
    ...
    assert_eq!(u64_field(summary, "checked"), 51, "summary checked");
    assert_eq!(u64_field(summary, "open"), 39, "summary open");
...
fn course_subcommand_human_view_lists_units() {
    ...
    assert!(
        last.contains("39") && last.contains("checked") && last.contains("failed"),
